...
precip=read.table('/Users/sihanwang/icu_estimat/hosp_precip.txt')[,c(1,3,9)]
cases=read.table('/Users/sihanwang/icu_estimat/hosp_cases.txt')[,c(1,3,9)]
deaths=read.table('/Users/sihanwang/icu_estimat/hosp_deaths.txt')[,c(1,3,9)]
hosp=read.table('/Users/sihanwang/icu_estimat/hosp_hospad.txt')[,c(1,3,9)]
icu=read.table('/Users/sihanwang/icu_estimat/hosp_icuad.txt')[,c(1,3,9)]
reproduction=read.table('/Users/sihanwang/icu_estimat/hosp_reproduction.txt')[,c(1,3,9)]
fatality=read.table('/Users/sihanwang/icu_estimat/hosp_fatality.txt')[,c(1,3,9)]
stringency=read.table('/Users/sihanwang/icu_estimat/hosp_stringency.txt')[,c(1,3,9)]
...
df.l1$week=as.Date(weekly$week[70:140])
df.l2$week=as.Date(weekly$week[70:140])
...
ggplot(df.l1, mapping=aes(as.Date(week)))+
  geom_line(mapping=aes(y=df.l1$icu_coef, color='week t-1'))+
  geom_line(mapping=aes(y=df.l2$icu_coef, color='week t-2'))+
  theme(panel.background = element_rect(fill = "white", colour = "black"))+
  scale_x_date(labels=date_format ("%m-%y"))+
  ggtitle('ICU admission Coeficient')+
